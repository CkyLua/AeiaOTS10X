-- The Forgotten Server Config
	...
	sqlHost = "127.0.0.1"
	sqlPort = 3306
	sqlUser = "04" --otserv  --04
	sqlPass = "ELPKRbRtpBBjGvfw" --zThA96eAH9u2V8Ty  --ELPKRbRtpBBjGvfw
	sqlDatabase = "04"  --otserv --04
	...
	dataDirectory = "Z:/D/aeia_git/AeiaOTS/data/" --data/     Z:/D/aeia_git/AeiaOTS/data/
	logsDirectory = "Z:/D/aeia_git/AeiaOTS/data/logs/" --data/logs/            Z:/D/aeia_git/AeiaOTS/data/logs
	bankSystem = true
	...
	experienceShareLevelDifference = 1 / 2
