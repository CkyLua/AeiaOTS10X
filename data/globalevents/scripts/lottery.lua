-- by vDk, klekSu
local config = {
lottery_hour = "5 Hours", -- Time to next lottery (real time you set on globalevents.xml, its only for broadcast message.)
rewards_id = {2160}, -- Rewards ID
crystal_counts = 2, -- used only if on rewards_id you have crystal coins (ID: 2160).
