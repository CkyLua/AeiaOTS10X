...
function onUse(cid, item, frompos, item2, topos)
   	...
   	if item.uid == 4073 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have saved the Crystal Caves.")
   			setPlayerStorageValue(cid,4072,1)
   		else
   			doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"This seal was saved.")
   		end
   	elseif item.uid == 4075 then
   		queststatus = getPlayerStorageValue(cid,4074)
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have saved the Blood Hall.")
   	...
   	elseif item.uid == 4077 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have saved the Vats.")
   	...
   	elseif item.uid == 4079 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have saved the Arcanum.")
   	...
   	elseif item.uid == 4081 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have saved the Hive.")
