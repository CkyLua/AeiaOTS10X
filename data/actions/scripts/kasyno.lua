    ...
    if(item.uid == 3456)then
        ...
        if getkasa.itemid == 2160 and getkasa.type == 5 then
            ...
            if rand == 1 or rand == 4 or rand == 3 then
                ...
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have lost 5 Crystal Coins .")
            end
            if rand == 2 then
                doRemoveItem(getkasa.uid,5)
                ...
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE," Congratulations! You won 15 Crystal Coins .")
            end
        end
        if getkasa.itemid == 2160 and getkasa.type == 10 then
            ...
            if rand == 1 or rand == 4 or rand == 3 then
                ...
                doSendMagicEffect(kasapos,2)
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have lost 10 Crystal Coins .")
            end
            if rand == 2 then
                doRemoveItem(getkasa.uid,10)
                ...
                doSendMagicEffect(winpos,13)
                doSendMagicEffect(topos,21)
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"Congratulations! You won 30 Crystal Coins .")
            end
        end
        if getkasa.itemid == 2160 and getkasa.type == 25 then
            ...
            if rand == 1 or rand == 4 or rand == 3 then
                ...
                doSendMagicEffect(kasapos,2)
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have lost 25 Crystal Coins .")
            end
            if rand == 2 then
                doRemoveItem(getkasa.uid,25)
                ...
                doSendMagicEffect(winpos,13)
                doSendMagicEffect(topos,21)
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE," Congratulations! You won 75 Crystal Coins  .")
            end
        end
        if getkasa.itemid == 2160 and getkasa.type == 50 then
            ...
            if rand == 1 or rand == 4 or rand == 3 then
                ...
                doSendMagicEffect(kasapos,2)
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"You have lost 50 Crystal Coins .")
            end
            if rand == 2 then
                doRemoveItem(getkasa.uid,50)
                ...
                doSendMagicEffect(winpos,13)
                doSendMagicEffect(topos,21)
                doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"Congratulations! You won 150 Crystal Coins .")
            end
        end
        if getkasa.itemid > 2160 or getkasa.itemid < 2160 then
            doPlayerSendTextMessage(cid,MESSAGE_EVENT_ADVANCE,"Place 5, 10, 25 or 50 Crystal Coins if you want to play.")
        end
