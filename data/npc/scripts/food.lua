...
shopModule:addBuyableItem({'haunch of boar'}, 13297, 12, 'haunch of boar')
...
shopModule:addBuyableItem({'coconut'}, 2678, 20, 'coconut')
shopModule:addBuyableItem({'trout'}, 7158, 24, 'trout')
shopModule:addBuyableItem({'perch'}, 7159, 22, 'perch')
shopModule:addBuyableItem({'pike'}, 2669, 20, 'pike')
